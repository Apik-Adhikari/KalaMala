...
const translations = {
    en: {
        ...
        checkout_place_order: "Place Order & Pay with eSewa",
        checkout_summary: "Order Summary",
        checkout_items: "Items",
        checkout_total: "Total Amount",
        checkout_error: "Please provide all shipping details",
        // Product Details
    ...
    ne: {
        ...
        cat_all: "सबै",
        cat_handicrafts: "हस्तकला",
        cat_woven: "बुनेका लुगाहरू",
        cat_lockets: "लकेट",
        cat_pottery: "माटोको भाँडा",
        cat_painting: "चित्रकला",
        // Cart Page
        ...
        checkout_shipping: "ढुवानी जानकारी",
        checkout_address: "ठेगाना",
        checkout_city: "शहर",
        checkout_province: "प्रदेश",
        checkout_phone: "फोन नम्बर",
        checkout_place_order: "अर्डर गर्नुहोस् र eSewa बाट भुक्तानी गर्नुहोस्",
        checkout_summary: "अर्डर सारांश",
        checkout_items: "सामानहरू",
        checkout_total: "कुल रकम",
        checkout_error: "कृपया सबै ढुवानी विवरणहरू प्रदान गर्नुहोस्",
        // Product Details
